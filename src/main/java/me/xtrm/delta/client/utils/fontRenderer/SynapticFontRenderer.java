package me.xtrm.delta.client.utils.fontRenderer;
...
public class SynapticFontRenderer {
    ...
    public SynapticFontRenderer(GlyphPage regularGlyphPage, GlyphPage boldGlyphPage, GlyphPage italicGlyphPage, GlyphPage boldItalicGlyphPage) {
    ...
    public static SynapticFontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic) {
        ...
        return new SynapticFontRenderer(regularPage, boldPage, italicPage, boldItalicPage);
    }
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
    	drawString(text, x - (int)getStringWidth(text) / 2, y, color, false);
    }
   
    public void drawCenteredStringWithShadow(String text, float x, float y, int color) {
    	drawString(text, x - (int)getStringWidth(text) / 2, y, color, true);
    }

...
public class GlyphPage {
    ...
    private boolean wierdThingWithTheI;
    
    public GlyphPage(Font font, boolean antiAliasing, boolean fractionalMetrics) {
    	this(font, antiAliasing, fractionalMetrics, false);
    }
    
    public GlyphPage(Font font, boolean antiAliasing, boolean fractionalMetrics, boolean wierdThingWithTheI) {
        this.font = font;
        this.antiAliasing = antiAliasing;
        this.fractionalMetrics = fractionalMetrics;
        this.wierdThingWithTheI = wierdThingWithTheI;
    }

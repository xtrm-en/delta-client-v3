 ...
 * 			  /!\ Shit Code /!\
 */
public class MainMenuHelper extends GuiNormalizedScreen {

	private static final CachedResource[] titlePanoramaPaths = new CachedResource[] {
			new CachedResource("https://nkosmos.github.io/assets/panorama_0.png"), 
			new CachedResource("https://nkosmos.github.io/assets/panorama_1.png"), 
			new CachedResource("https://nkosmos.github.io/assets/panorama_2.png"), 
			new CachedResource("https://nkosmos.github.io/assets/panorama_3.png"), 
			new CachedResource("https://nkosmos.github.io/assets/panorama_4.png"), 
			new CachedResource("https://nkosmos.github.io/assets/panorama_5.png")
	};
    ...
    public void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int k = 0; k < b0 * b0; ++k)
        {
            ...
            for (int l = 0; l < 6; ++l)
            {
                ...
                RenderUtils.bindCachedResource(titlePanoramaPaths[l]);

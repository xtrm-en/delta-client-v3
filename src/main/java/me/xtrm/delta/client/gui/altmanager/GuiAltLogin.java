...
public class GuiAltLogin extends GuiNormalizedScreen {
    ...
    private static final CachedResource mojangLogo = new CachedResource("https://indiesjv.files.wordpress.com/2011/12/mojangnew.png"); 
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), 0xFF222222);
